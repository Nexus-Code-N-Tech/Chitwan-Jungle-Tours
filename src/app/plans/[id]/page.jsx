  ...
  <div className="lg:col-span-2 md:col-span-2 col-span-1 bg-gray-300 w-full h-full p-5 md:p-10 rounded-tr-full">
    ...
    <div className="description mt-5 text-[#666666]">
      <p className="short-description mb-6">
        ...
        dignissimos facere autem quod est nesciunt sed tempora dolores ratione
        illo?
      </p>
      <p>
      ...
      <div className="mt-10 grid gap-6">
        <p>
          ...
          <br />
          The best way to get to Chitwan from Kathmandu or Pokhara depends on
        ...
        <p>
          ...
          depending on traffic and road conditions. You can take a tourist bus,
          a private car, or a taxi. The tourist bus is the most economical
          option.
        </p>
        <p>
          <strong>From Pokhara to Chitwan:</strong> The road journey from
          Pokhara to Chitwan takes around 5-6 hours. You can also take a tourist
        ...
        <p>
          ...
          You can take a domestic flight from Kathmandu to Bharatpur, which is
          the nearest airport to Chitwan. The flight takes around 20 minutes,
          followed by a short drive to Chitwan National Park.
        </p>
        <p>
          <strong>From Pokhara to Chitwan:</strong> There are also direct
          flights from Pokhara to Chitwan daily. The flight will take around 18
          minutes, followed by a short drive to Chitwan National Park.
        </p>
        <p>
          <strong>By Bus:</strong>
          <br />
          There are direct bus services from Kathmandu and Pokhara to Chitwan.
          The bus journey is relatively inexpensive but can be long and
          uncomfortable due to road conditions.
          <br />
          <br />
          We offer Chitwan Jungle Safari packages with 1 night tower stay that
          include transportation from Kathmandu or Pokhara to Chitwan and return
