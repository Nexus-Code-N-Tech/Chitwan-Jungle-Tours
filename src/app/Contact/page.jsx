        ...
        <div className="form-container w-full md:w-1/2 p-6 bg-gray-100 rounded-lg">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="border-2 rounded-md pl-6"
              name="fname"
              required
            />
            <sup className="text-red-500 text-xl"> *</sup>
            <br />
            <br />
            Last Name:{" "}
            <input
            ...
            <input
              ...
              className="border-2 rounded-md pl-16"
              name="email"
              required
            />
            <sup className="text-red-500 text-xl"> *</sup>
            ...
            <input
              ...
              className="border-2 rounded-md pl-12"
              required
              name="country"
            />
            <sup className="text-red-500 text-xl"> *</sup>
            ...
            <input
              ...
              className="border-2 rounded-md pl-20"
              required
              name="city"
            />
            <sup className="text-red-500 text-xl"> *</sup>
            ...
            <input
              ...
              className="border-2 rounded-md pl-11"
              name="zip"
            />
            <br />
            <br />
            ...
            <div className="mb-4">
              ...
              <button
                type="reset"
                className="bg-red-700 hover:bg-red-800 px-4 py-2 rounded-md text-white"
              >
                Reset
              </button>
            </div>
